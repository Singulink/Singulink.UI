...
public abstract class RoutedObservableViewModel : ObservableObject, IRoutedViewModel
{
    ...
    public virtual ValueTask OnNavigatedToAsync(NavigationArgs args) => ValueTask.CompletedTask;

    /// <inheritdoc cref="IRoutedViewModelBase.OnNavigatingFromAsync"/>
    public virtual ValueTask OnNavigatingFromAsync(NavigatingCancelArgs args) => ValueTask.CompletedTask;

...
/// <summary>
/// Represents a view model that can be navigated away from.
/// </summary>
public interface IRoutedViewModelBase
{
    ...
    /// </remarks>
    public ValueTask OnNavigatedToAsync(NavigationArgs args);

    /// <summary>
    /// Invoked when the view model is being navigated away from and allows the navigation to be cancelled.
    /// </summary>
    /// <remarks>
    /// This method can show dialogs as long as they are closed before the task completes. The <see cref="NavigatingCancelArgs.Cancel"/> property is checked on
    /// <paramref name="args"/> after the task returned by this method completes. This method cannot reroute to another destination.
    /// </remarks>
    public ValueTask OnNavigatingFromAsync(NavigatingCancelArgs args);

...
/// </summary>
/// <typeparam name="TParam">The type of the parameter, or a tuple in the case of multiple parameters.</typeparam>
public interface IRoutedViewModel<TParam> : IRoutedViewModelBase where TParam : notnull
{
    /// <summary>
    /// Gets or sets the route parameter (or parameters tuple if there are multiple parameters) for this view model. This property is set once prior to any

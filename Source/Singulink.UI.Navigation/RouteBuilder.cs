...
public class RouteBuilder
{
    ...
    public Route<TViewModel> For<TViewModel>()
        where TViewModel : IRoutedViewModel
    {
        return new Route<TViewModel>(this);
    }

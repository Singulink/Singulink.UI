...
/// </summary>
public class MessageDialogViewModel : IDismissableDialogViewModel
{
    ...
    /// </summary>
    public MessageDialogViewModel(IDialogNavigator dialogNavigator, MessageDialogOptions options)
    {

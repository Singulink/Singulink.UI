...
public static class DialogNavigatorExtensions
{
    ...
    public static async Task ShowMessageDialogAsync(this IDialogNavigatorBase navigator, string message)
    {
    ...
    public static async Task ShowMessageDialogAsync(this IDialogNavigatorBase navigator, string message, string title)
    {
    ...
    public static async Task<int> ShowMessageDialogAsync(this IDialogNavigatorBase navigator, string message, IEnumerable<string> buttonLabels)
    {
